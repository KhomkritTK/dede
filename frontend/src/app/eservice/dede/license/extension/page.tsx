...
export default function ProductionExtensionPage() {
  ...
  const onSubmit = async (data: ExtensionFormData) => {
    ...
    try {
      ...
      console.log('Submitting production extension request:', data)
    ...
    <PublicLayout>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <div className="mt-6">
              ...
              {errors.extensionReason && (
                <p className="mt-1 text-sm text-red-600">{errors.extensionReason.message}</p>
              )}
            </div>
          </div>
          ...
          {/* Extension Details */}
          <div className="bg-white shadow rounded-lg p-6">
            <h2 className="text-lg font-medium text-gray-900 mb-4">รายละเอียดการขอขยาย</h2>
