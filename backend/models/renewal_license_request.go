...
// RenewalLicenseRequest represents a renewal license request
type RenewalLicenseRequest struct {
	...
	RequestedExpiryDate time.Time `json:"requested_expiry_date" gorm:"not null"`
